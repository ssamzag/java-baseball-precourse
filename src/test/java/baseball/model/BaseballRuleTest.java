    ...
    static Stream<Arguments> parametersProvider() {
        return Stream.of(
                arguments(
                        ...
                        1,
                        new BaseballNumbers(Arrays.asList(1, 2, 4)),
                        new BaseballNumbers(Arrays.asList(1, 2, 4))),
                arguments(
                        JudgementType.BALL,
                        1,
                        new BaseballNumbers(Arrays.asList(3, 1, 4)),
                        new BaseballNumbers(Arrays.asList(1, 3, 4))),
                arguments(
                        JudgementType.NOTHING,
                        1,
                        new BaseballNumbers(Arrays.asList(5, 2, 4)),
                        new BaseballNumbers(Arrays.asList(1, 3, 5)))
        );
    }
